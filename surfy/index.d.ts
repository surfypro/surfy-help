...
declare type CompanyPropertyNames = 'id' | 'name' | 'logoPath' | 'iconPath' | 'proxyImages' | 'workingDaysCount' | 'enablePathfinding' | 'planningNumberOfDays' | 'enableCrowdedDimensionForBooking' | 'enableBuildingBookingWhenAllDimensionsAreCrowded' | 'workplaceBookingConfirmationRange' | 'createdAt' | 'updatedAt' | 'externalId' | 'companyTypeId' | 'companyType' | 'userCompanies' | 'buildingTypes' | 'buildings' | 'companyWorkingLocations';
...
declare namespace Surfy {
    ...
    interface UserCompany extends IEntity {
        ...
        workplaceUsageTypeCreatedBies?: IPaginationList<WorkplaceUsageType>;
        workplaceUsageTypeUpdatedBies?: IPaginationList<WorkplaceUsageType>;
    ...
    interface WorkplaceUsageType extends IEntity {
        id: number;
        name: string;
        color: string;
        description?: string;
    ...
    interface Workplace extends IEntity {
        ...
        organizationId?: number | null;
        costCenterId?: number | null;
        workplaceUsageTypeId?: number | null;
        userCompanyCreatedById?: number | null;
        userCompanyUpdatedById?: number | null;
        companyId?: number | null;
        workplaceType?: WorkplaceType;
        ...
        organization?: Organization;
        costCenter?: CostCenter;
        workplaceUsageType?: WorkplaceUsageType;
        userCompanyCreatedBy?: UserCompany;
        userCompanyUpdatedBy?: UserCompany;
        company?: Company;
        items?: IPaginationList<Item>;
    ...
    interface PersonToWorkplaceBooking extends IEntity {
        ...
        endDatetime: string;
        workspaceHasBeenConfirmedAt?: string;
        createdAt?: string;
        updatedAt?: string;
        externalId?: string;
        personId: number;
