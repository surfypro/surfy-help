...
declare type CompanyPropertyNames = 'id' | 'name' | 'logoPath' | 'iconPath' | 'proxyImages' | 'workingDaysCount' | 'enablePathfinding' | 'planningNumberOfDays' | 'createdAt' | 'updatedAt' | 'externalId' | 'companyTypeId' | 'companyType' | 'userCompanies' | 'buildingTypes' | 'buildings';
...
export declare type JupLanguageCode = 'fr' | 'en' | 'es' | 'it' | 'nl';
...
export declare type MomentLocalCode = 'fr' | 'en-gb' | 'es' | 'it' | 'nl';
...
declare type WorkingLocationPropertyNames = 'id' | 'name' | 'code' | 'createdAt' | 'updatedAt' | 'externalId' | 'personWorkingLocations';
