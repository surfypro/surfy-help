...
declare type BookingVehicleConfigurationPropertyNames = 'id' | 'createdAt' | 'updatedAt' | 'externalId' | 'vehicleTypeId' | 'vehicleType' | 'vehiclePropulsionTypeId' | 'vehiclePropulsionType' | 'userCompanyCreatedById' | 'userCompanyCreatedBy' | 'userCompanyUpdatedById' | 'userCompanyUpdatedBy' | 'bookingVehicleConfigurationToParkingRoomTypeConfigurations' | 'companyId' | 'company';

declare type BookingVehicleConfigurationPropertyTypeRecord = Record<BookingVehicleConfigurationPropertyNames, IPropertyTypeDefinition>;

declare type BookingVehicleConfigurationToParkingRoomTypeConfigurationPropertyNames = 'id' | 'allowDaySlotAm' | 'allowDaySlotPm' | 'allowDaySlotAll' | 'singleBookingPerDay' | 'parkingRoomTypeCode' | 'createdAt' | 'updatedAt' | 'externalId' | 'bookingVehicleConfigurationId' | 'bookingVehicleConfiguration' | 'userCompanyCreatedById' | 'userCompanyCreatedBy' | 'userCompanyUpdatedById' | 'userCompanyUpdatedBy' | 'companyId' | 'company';

declare type BookingVehicleConfigurationToParkingRoomTypeConfigurationPropertyTypeRecord = Record<BookingVehicleConfigurationToParkingRoomTypeConfigurationPropertyNames, IPropertyTypeDefinition>;
...
declare type JupRolePropertyNames = 'id' | 'code' | 'name' | 'isClaim' | 'excludeScenarios' | 'createdAt' | 'updatedAt' | 'externalId' | 'jupUserCompanyToJupRoles' | 'jupRoleToJupUiViews' | 'jupRoleToJupObjectTypes' | 'jupRoleToJupUiOptions' | 'jupRoleToJupUiOperations' | 'apiUserToJupRoles' | 'userRegistrationTenantRuleToJupRoles' | 'jupRoleToJupUiLayouts' | 'jupRoleToJupUiLayoutTabs';
...
export declare function ObjectType(props: {
    code: VisibleCamelizedObjectTypeNames;
...
declare type ObjectTypeTranslations = Record<CamelizedSingularObjectTypes, {
    label: string;
...
declare type ParkingRoomTypeCode = 'PARKING-CAR' | 'PARKING-ELECTRIC-CAR' | 'PARKING-PRM';
...
declare type PersonTypePropertyNames = 'id' | 'name' | 'code' | 'createdAt' | 'updatedAt' | 'externalId' | 'people';

declare type PersonTypePropertyTypeRecord = Record<PersonTypePropertyNames, IPropertyTypeDefinition>;
...
export declare function PropertyType(props: {
...
declare type PropertyTypeJupType = 'string' | 'float' | 'square-image' | 'timestamp' | 'image' | 'address' | 'integer' | 'primary-key' | 'icon' | 'color' | 'date' | 'foreign-key' | 'belongs-to' | 'has-many' | 'has-many-paginated' | 'boolean' | 'surface' | 'distance' | 'point2d' | 'text' | 'text-md' | 'currency' | 'percentage' | 'point3d' | 'surface-by-people' | 'surface-by-workplace' | 'boolean' | 'textAnchor' | 'integer-count' | 'percentage0-1' | 'url' | 'password' | 'year' | 'model3d' | 'size' | 'transform' | 'weight' | 'icon-shape' | 'parking-room-type' | 'datetime' | 'day-slot' | 'legend-configuration' | 'floor-navigation-graph';
...
declare type PropertyTypeJupValues = string | string[] | number | number[] | boolean | null | IPoint3d | IPoint2d | IEntity | IEntity[] | IJupImage | IModel3d | IJupIcon | IJupAddress | IJupTransform | IconShapeType | DaySlotType | ParkingRoomTypeCode | IJupLegendConfiguration | IFloorPathfindingGraph;
...
declare type PropertyTypeTranslations = Record<CamelizedSingularObjectTypes, Record<string, {
    label: string;
    description: string | null;
}>>;
...
declare type StructurePropertyNames = 'id' | 'name' | 'transform' | 'anchorLatLng' | 'createdAt' | 'updatedAt' | 'externalId' | 'userCompanyCreatedById' | 'userCompanyCreatedBy' | 'userCompanyUpdatedById' | 'userCompanyUpdatedBy' | 'structurePoints' | 'floors' | 'companyId' | 'company';

declare type StructurePropertyTypeRecord = Record<StructurePropertyNames, IPropertyTypeDefinition>;

declare type SupportedLanguageCode = Extract<JupLanguageCode, 'fr' | 'en'>;
...
export declare function useCurrentLocale(): SupportedLanguageCode;
...
export declare function useTranslations(): ITranslations;
...
declare type VehiclePropulsionTypePropertyNames = 'id' | 'name' | 'color' | 'code' | 'icon' | 'createdAt' | 'updatedAt' | 'externalId' | 'vehicles' | 'bookingVehicleConfigurations';

declare type VehiclePropulsionTypePropertyTypeRecord = Record<VehiclePropulsionTypePropertyNames, IPropertyTypeDefinition>;

declare type VehicleTypePropertyNames = 'id' | 'name' | 'color' | 'code' | 'icon' | 'createdAt' | 'updatedAt' | 'externalId' | 'vehicles' | 'bookingVehicleConfigurations';
