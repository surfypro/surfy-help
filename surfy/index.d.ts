...
declare type JupRolePropertyNames = 'id' | 'code' | 'name' | 'isClaim' | 'createdAt' | 'updatedAt' | 'externalId' | 'jupUserCompanyToJupRoles' | 'jupRoleToJupUiViews' | 'jupRoleToJupObjectTypes' | 'jupRoleToJupUiOptions' | 'jupRoleToJupUiOperations' | 'apiUserToJupRoles' | 'userRegistrationTenantRuleToJupRoles' | 'jupRoleToJupUiLayouts' | 'jupRoleToJupUiLayoutTabs';
