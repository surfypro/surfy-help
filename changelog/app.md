...
- Mise à jour des icones de fontawesome en version 6.5.2
- Mise en place d'un mode avancé pour la visualisation des type d'objets en 3D pour les prévisualiser sans les axes et la zone d'occupation au sol
