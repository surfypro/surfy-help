...
- <OT code="workplaceType" />
  ...
  - Lors de l’ajout d’un poste de travail sur le plan, le libellé reprend cette position définie sur le type. Guide détaillé : [Point d'ancrage du texte sur un type de poste](/entities/user-guide/floor-plan/workplace-type-text-anchor).
