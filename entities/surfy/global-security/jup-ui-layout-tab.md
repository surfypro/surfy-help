...
### Nom de l'onglet {#name}

Le nom de l'onglet affiché dans l'interface

*Nom technique:* ```name```
<PH code="jupUiLayoutTab:name"/>
...
<PH code="jupUiLayoutTab:jupRoleToJupUiLayoutTabs"/>
