...
Pour plus d'information sur la création d'un calque d'analyse, voir le chapitre [Créer un calque d'analyse](https://help.surfy.pro/docs/dimensionType/create)
