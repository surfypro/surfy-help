...
Pour cela, il faut tout d'abord créer les types d'usage à utiliser :

Depuis le menu de gauche,
-   cliquer sur "Mobilier" puis "Typologies" puis "Type d'usage de poste de travail"
-   pour lister les types d'usage existants, cliquer sur "Lister les types d'usage de poste de travail". Chaque type d'usage peut être modifié en cliquant sur l'icône en début de ligne du type d'usage afin de "Modifier le type d'usage de poste de travail XXX".
-   pour créer un nouveau type d'usage de poste de travail, cliquer sur "Créer un type d'usage de poste de travail". Renseigner le nom et la couleur associés au type d'usage puis valider la création.

Une fois les types d'usage créés, on peut associer chaque poste de travail à un type d'usage et visualiser les postes de travail sur le plan, dans la couleur de leur type d'usage.

Pour associer un type d'usage à un poste de travail,

-   cliquer sur le poste de travail à qualifier
-   "Modifier" le poste de travail dans la fiche du poste de travail apparaissant à gauche du plan
-   cliquer sur l'icône "Crayon" du "type d'usage de poste de travail"
-   sélectionner le type d'usage voulu pour le poste de travail
-   sauvegarder la modification

Pour visualiser les postes de travail suivant leur type d'usage,

-   afficher le plan de l'étage à visualiser
-   cliquer sur l'icône verticale "étiquette" pour "colorier les postes de travail par rapport à leur type d'usage"
-   cliquer sur "tout sélectionner" afin de colorier les postes de travail sur le plan en fonction de leur type d'usage.

 On peut colorier tout ou partie des types d'usage en cliquant sur les coches de chaque type d'usage.

Le nombre de postes de travail par type d'usage est indiqué face à chaque type d'usage.
